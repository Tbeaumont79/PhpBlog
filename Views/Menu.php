...
function menuPage()
{
	...
	$htmlElement .= '<h4 class= "my-0 mr-md-auto font-weight-normal ml-md-5" font-family:Roboto Mono;><a class="text-dark text-decoration-none" href="index.php?page=index">Thibault Beaumont</a></h4>';
